...
os.environ['TRANSFORMERS_CACHE'] = 'E:\\YCJH\\Project\\2_2024.07.29-08.04\\cache'
os.environ['HF_HOME'] = 'E:\\YCJH\\Project\\2_2024.07.29-08.04\\cache'
...
class VASTZeroFewShot(Dataset):
    def __init__(self, phase, model='bert-base', wiki_model='', senti_flag=False, graph_flag=False, summa_flag=False):
        ...
        if model == 'bert-base':
            tokenizer = AutoTokenizer.from_pretrained('bert-base-uncased', mirror='https://hf-mirror.com')
        elif model == 'bertweet':
            tokenizer = AutoTokenizer.from_pretrained('vinai/bertweet-base', mirror='https://hf-mirror.com')
        else: # covid-twitter-bert
            tokenizer = AutoTokenizer.from_pretrained('digitalepidemiologylab/covid-twitter-bert-v2', mirror='https://hf-mirror.com')
        ...
        if wiki_model:
            ...
            if wiki_model == model:
                ...
                tokenizer_wiki = AutoTokenizer.from_pretrained('bert-base-uncased', mirror='https://hf-mirror.com')
        ...
        if senti_flag:
            # read summarization
            senti_tokenizer = AutoTokenizer.from_pretrained("twitter-roberta-base-sentiment-latest", mirror='https://hf-mirror.com')
            if summa_flag:
